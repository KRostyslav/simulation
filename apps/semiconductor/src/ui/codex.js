/**
 * Довідник теорії у модальному вікні.
 *
 * Статті згруповані за темами шкільної програми, а перехресні посилання
 * `see` перетворені на кнопки: тему рідко можна зрозуміти, читаючи один
 * абзац, і перехід «дірка → рухливість → температура» тут за один клік.
 */
